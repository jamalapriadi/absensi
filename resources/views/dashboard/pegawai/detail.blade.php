...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title">Tambah Tugas Pegawai</h6>
        </div>
        <div class="panel-body">
            ...
            <form class="form-horizontal" id="formJabatan" onsubmit="return false;">
                <div class="form-group">
                    ...
                    <input class="form-control" name="nama jabatan" value="{{$pegawai->nama_lengkap}}" readonly>
                </div>
                <div class="form-group">
                    <label class="col-lg-3 control-label">Tugas Pegawai</label>
